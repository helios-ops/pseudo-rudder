...
extern VC_DELETEEXPR		      vc_DeleteExpr;

extern VC_GET_WHOLECOUNTEREXAMPLE     vc_getWholeCounterExample;

extern VC_GET_TERMFROMCOUNTEREXAMPLE  vc_getTermFromCounterExample;
