...
g++ HH_asm_insn_2_vine_ir.cpp IR_operation.cpp label_queue.cpp record2file.cpp H_STP_stub.o stp_variables.o GetTemuData.o SymExe.o dbg_util.o ../i386_reg_init.o sym_addr_resolve.o -I../.. -I../../apps -I../include -I../../../VEX//pub -g -O2 -L. -L../../src -L../../../VEX/ -g -O2 -L../../src -L../../../VEX/ -shared -fPIC -o IR_SymEXE.so -lasmir -lvex -lbfd -liberty -lopcodes -liberty -Xlinker -rpath ./
