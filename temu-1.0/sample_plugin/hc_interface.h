...
extern "C"{
  ...
  typedef void* HWholeCounterExample;
...
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */  
  ...
  HExpr vc_sbvDivExpr(HVC vc, int n_bits, HExpr left, HExpr right);

  // left modulo right i.e. left%right
  // HExpr vc_signBvModExpr(HVC vc, int n_bits, HExpr left, HExpr right);
  HExpr vc_sbvModExpr(HVC vc, int n_bits, HExpr left, HExpr right);
  ...
  void vc_DeleteExpr(HExpr expr);

  HWholeCounterExample vc_getWholeCounterExample(HVC vc);

  HExpr _Z28vc_getTermFromCounterExamplePvS_PN4BEEV22CompleteCounterExampleE( HVC   		   vc,
									      HExpr		   expr,
									      HWholeCounterExample wce
									   );

  /*
  HExpr H_var_substitute_4expr( HVC   vc,
			        HExpr dst_expr,
			        HExpr var_expr,
			        HExpr sub_expr
			      );
  */
  ...
  /*
  HExpr _Z22H_var_substitute_4exprPvPS_S0_S0_i( HVC     vc,
 			   		        HExpr   dst_expr,
			        		HExpr * var_expr,
			        		HExpr * sub_expr,
						int     count
  ...
  */
  HExpr H_var_substitute_4expr( HVC     vc,
			        ...
			        HExpr * sub_expr,
				int     count,
				void (* H_printExpr)(void *, int)
			      );


  int getExprKind(HExpr expr);

  #ifndef vc_getTermFromCounterExample
    #define vc_getTermFromCounterExample _Z28vc_getTermFromCounterExamplePvS_PN4BEEV22CompleteCounterExampleE
  #endif
