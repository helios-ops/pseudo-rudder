...
/* Line 268 of yacc.c  */
#line 1 "combine_protocol_analysis_yacc.y"
...
/* Line 268 of yacc.c  */
#line 318 "combine_protocol_analysis_yacc.tab.c"
...
/* Line 343 of yacc.c  */
#line 368 "combine_protocol_analysis_yacc.tab.c"
...
{
       0,     0,     3,     9,    10,    13,    19,    20,    23
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      10,     0,    -1,     3,     4,     7,     4,    11,    -1,    -1,
      12,    11,    -1,     5,     4,     7,     4,    13,    -1,    -1,
      14,    13,    -1,     7,     6,    -1
};
...
{
       0,   253,   253,   264,   265,   268,   279,   280,   284
};
#endif
...
{
  "$end", "error", "$undefined", "LEN_DOMAIN", "TOKENIZER", "BYTE_COUNT",
  "SEMICOLON", "NUMBER", "SEPARATOR", "$accept", "header", "statements",
  "statement", "terms", "term", 0
};
#endif
...
{
      -3,    -2,     1,    -4,   -12,     0,     2,     4,   -12,     2,
      -1,   -12,     5,     3,     6,   -12,     3,   -12,   -12
};
...
{
       0,     3,    10,     4,     0,     7,     4,     5,    11,    12,
       4,    11,     7,     4,     7,    13,    14,     6,    13
};
...
/* Line 1806 of yacc.c  */
#line 254 "combine_protocol_analysis_yacc.y"
    {
	#ifdef H_USE_PROTOCOL_ANALYSIS
	    total_len_count   = h_atoint((yyvsp[(3) - (5)]));
...
/* Line 1806 of yacc.c  */
#line 269 "combine_protocol_analysis_yacc.y"
    {
	   /*
	   #ifdef H_USE_PROTOCOL_ANALYSIS
...
/* Line 1806 of yacc.c  */
#line 285 "combine_protocol_analysis_yacc.y"
    {	  
      #ifdef H_USE_PROTOCOL_ANALYSIS
	  ...
	  total_len_domains[current_byte_idx] = h_atoint((yyvsp[(1) - (2)]));
...
/* Line 1806 of yacc.c  */
#line 1636 "combine_protocol_analysis_yacc.tab.c"
      default: break;
    }
...
/* Line 2067 of yacc.c  */
#line 303 "combine_protocol_analysis_yacc.y"
