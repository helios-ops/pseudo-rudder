...
#include "stp_variables.h"
  ...
  typedef int (*VC_GETBVLENGTH)(HVC vc, HExpr e);
...
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */  
  ...
  */  
  ...
  typedef void (*VC_DELETEEXPR)(HExpr expr);

  typedef HWholeCounterExample (*VC_GET_WHOLECOUNTEREXAMPLE)(HVC vc);

  typedef HExpr (*VC_GET_TERMFROMCOUNTEREXAMPLE)( HVC  		       vc,
						  HExpr 	       expr,
						  HWholeCounterExample wc
						);
  


typedef void (*OBTAIN_STP_UTILS_FROM_PLUGIN)( VC_CREATEVALIDITYCHECKER   myvc_createValidityChecker,
				...
				VC_SIGNBVDIVEXPR	   myvc_signBvDivExpr,
				VC_SIGNBVMODEXPR	   myvc_signBvModExpr,
