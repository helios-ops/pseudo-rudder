...
void OPPROTO op_testl_T0_T1_cc(void)
{
    ...
    // HHui added at Feb 4th, 2012 
    taintcheck_update_eflags(CC_S | CC_Z | CC_P );
...
// no taint has ever been introduced !
	...
	temu_plugin->HHui_write_register_access( R_EAX,
						 0,
				      	         2
				   	       );	
    }// end of if( )
...
void OPPROTO op_mulw_AX_T0(void)
{
	...
	temu_plugin->HHui_write_register_access( R_EDX,
						 0,
				      	         2
				   	       );	
    }// end of if( )
...
{
/* HHui patched at March 23rd, 2012 ---- originally not existed !*/
/* ------------------------------------------------------------------------------------ */
#if TAINT_ENABLED
    if( (temu_plugin != NULL) &&
        (temu_plugin->HHui_write_register_access != NULL)
...
void OPPROTO op_decl_ECX(void)
{
	...
	temu_plugin->HHui_write_register_access( R_ECX,
					 	 0,
				      	         4
				   	       );	
    }// end of if( )
...
void op_addl_ESP_4(void)
{
	...
	temu_plugin->HHui_write_register_access( R_ESP,
					 	 0,
				      	         4
				   	       );	
...
void op_addl_ESP_2(void)
{
	...
	temu_plugin->HHui_write_register_access( R_ESP, // R_EAX,
					 	 0,
				      	         4
				   	       );	
    }// end of if( )
...
void OPPROTO op_taintcheck_jnz_T0_label(void)
{
    ...
    if(res == 2) // 2 means the other branch ??
    {
        GOTO_LABEL_PARAM(1);
    }
    else if(res == 1) 
